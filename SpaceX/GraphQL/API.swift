...
public final class LaunchDetailsQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Launch: GraphQLSelectionSet {
      ...
      public init(launchSite: LaunchSite? = nil, missionName: String? = nil, launchDateUtc: String? = nil, rocket: Rocket? = nil, details: String? = nil, links: Link? = nil, upcoming: Bool? = nil) {
        self.init(unsafeResultMap: ["__typename": "Launch", "launch_site": launchSite.flatMap { (value: LaunchSite) -> ResultMap in value.resultMap }, "mission_name": missionName, "launch_date_utc": launchDateUtc, "rocket": rocket.flatMap { (value: Rocket) -> ResultMap in value.resultMap }, "details": details, "links": links.flatMap { (value: Link) -> ResultMap in value.resultMap }, "upcoming": upcoming])
      }
