    ...
    public struct Launch: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLField("upcoming", type: .scalar(Bool.self)),
        ]
      }
      ...
      public init(id: GraphQLID? = nil, launchSite: LaunchSite? = nil, missionName: String? = nil, launchDateUtc: String? = nil, rocket: Rocket? = nil, details: String? = nil, links: Link? = nil, upcoming: Bool? = nil) {
        self.init(unsafeResultMap: ["__typename": "Launch", "id": id, "launch_site": launchSite.flatMap { (value: LaunchSite) -> ResultMap in value.resultMap }, "mission_name": missionName, "launch_date_utc": launchDateUtc, "rocket": rocket.flatMap { (value: Rocket) -> ResultMap in value.resultMap }, "details": details, "links": links.flatMap { (value: Link) -> ResultMap in value.resultMap }, "upcoming": upcoming])
      }
      ...
      public var upcoming: Bool? {
        get {
          return resultMap["upcoming"] as? Bool
        }
        set {
          resultMap.updateValue(newValue, forKey: "upcoming")
        }
      }
      ...
      public struct Rocket: GraphQLSelectionSet {
        ...
        public struct Rocket: GraphQLSelectionSet {
          ...
          public init(height: Height? = nil, mass: Mass? = nil, diameter: Diameter? = nil) {
            self.init(unsafeResultMap: ["__typename": "Rocket", "height": height.flatMap { (value: Height) -> ResultMap in value.resultMap }, "mass": mass.flatMap { (value: Mass) -> ResultMap in value.resultMap }, "diameter": diameter.flatMap { (value: Diameter) -> ResultMap in value.resultMap }])
          }
      ...
      public struct Link: GraphQLSelectionSet {
        ...
        public init(missionPatch: String? = nil, flickrImages: [String?]? = nil, wikipedia: String? = nil, articleLink: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "LaunchLinks", "mission_patch": missionPatch, "flickr_images": flickrImages, "wikipedia": wikipedia, "article_link": articleLink])
        }
...
public final class LaunchListQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("launchesPast", arguments: ["limit": GraphQLVariable("pageSize"), "offset": GraphQLVariable("offset")], type: .list(.object(LaunchesPast.selections))),
      ]
    }
    ...
    public struct LaunchesPast: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID? = nil, launchSite: LaunchSite? = nil, missionName: String? = nil, links: Link? = nil, launchYear: String? = nil, launchDateUtc: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "Launch", "id": id, "launch_site": launchSite.flatMap { (value: LaunchSite) -> ResultMap in value.resultMap }, "mission_name": missionName, "links": links.flatMap { (value: Link) -> ResultMap in value.resultMap }, "launch_year": launchYear, "launch_date_utc": launchDateUtc])
      }
